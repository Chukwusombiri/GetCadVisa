<div class="flex flex-wrap items-center mb-5">
    ...
    <div class="flex flex-col w-full md:w-7/12 mb-2 md:mb-0 mr-0 md:mr-3">
        <input type="text" wire:model="email" class="appearance-none w-full hind-medium outline-none px-4 py-2 md:py-4 mr-3 rounded-full border border-gray-900 focus:border-gray-900" placeholder="Enter your email">
