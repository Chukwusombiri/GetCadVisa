<x-wire-modal formAction="workContact">
    <x-slot name="title">
        Get a Free Canadian Citizenship Consultation with VISACAD Citizenship team.
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="mb-4">
            <x-label for="comment" value="{{ __('Please provide information about your citizenship enquiry') }}" />
            <textarea id="comment" wire:model="comment" rows="5" placeholder="Summarize your inquiry"
        ...
        <div class="mb-4">
            <x-label for="terms">
                <div class="flex items-center">
                    <x-checkbox id="terms"/>
                    <div class="ml-2">
                        {!! __('Yes, please send me the free Canadian Citizenship Newsletter by email') !!}
                    </div>
                </div>                
            </x-label>
        </div>
