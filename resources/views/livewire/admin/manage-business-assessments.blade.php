<div class="card">
  <div class="card-header">      
    <div class="flex justify-between items-center">  
      <h3 class="text-3xl text-rose-700 futura-medium tracking-wide mb-4 md:mb-0">Business visa assessments</h3>      
          ...
          <tr>
            ...
            <td class="d-flex">                
                <div class="flex flex-nowrap justify-between items-center gap-x-1">
                  <a href="{{route('admin.business_assessment.show',[$assessment->id])}}" class="border-2 border-rose-700 rounded-2xl text-xs font-semibold tracking-wide hover:bg-rose-800 hover:border-rose-800 px-2 bg-rose-700 text-gray-100 hover:text-gray-50 py-2 px-4">view</a>
                  <button wire:click='$emit("openModal","admin.delete-business-assessment",@json([$assessment->id]))' 
